...
def update_profil(current_user):
    try:
        ...
        print(f"DEBUG ERROR PROFIL: {str(e)}") # Cek terminal untuk error detail
        return jsonify({'error': str(e)}), 500